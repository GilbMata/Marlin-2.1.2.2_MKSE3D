...
#define STRING_CONFIG_H_AUTHOR "(GilMata)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GiPrinter3D"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 194 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 50, -2.20 }
